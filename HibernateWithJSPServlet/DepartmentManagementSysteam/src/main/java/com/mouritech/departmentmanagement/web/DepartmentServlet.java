...
public class DepartmentServlet extends HttpServlet {
	...
	private void updateDepartment(HttpServletRequest req, HttpServletResponse resp) 	
			throws IOException,ServletException,SQLException {
		Integer deptid = Integer.parseInt(req.getParameter("did"));
		String deptname = req.getParameter("dname");
//		String deptemail = req.getParameter("eemail");
//		String deptmobno = req.getParameter("emobno");
	...
	private void insertDepartment(HttpServletRequest req, HttpServletResponse resp) 
		...
		//Longdeptid =      (long) Integer.parseInt(req.getParameter("did"));
		String deptname = req.getParameter("dname");
